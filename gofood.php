...
if ($register == false)
	...
	if ($verif == false)
		{
		echo "Gagal Mendaftarkan Akun, Silahkan Dicoba Kembali!\n";
		}
	  else
		{
		echo "BERHASIL MENDAPATKAN VOUCHER!, ";
		$claim = claim($verif);
		if ($claim == false)
			{
			...
			{
			echo "SILAHKAN CEK AKUN GOJEK ANDA";
			}
		}
	}
}else if($type == 1){
...
if ($login == false)
	...
	if ($verif == false)
		{
		echo "Gagal Masuk Akun Anda, Silahkan Dicoba Kembali!!\n";
		}
	  else
		{
		echo "BERHASIL MENDAPATKAN VOUCHER, ";
